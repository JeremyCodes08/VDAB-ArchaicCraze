...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		noModsTxt.setFormat(Fonts.font), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		buttonToggle.label.setFormat(Fonts.font, 24, FlxColor.WHITE, CENTER);
		...
		buttonUp.label.setFormat(Fonts.font), 24, FlxColor.BLACK, CENTER);
